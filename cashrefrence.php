...
<body class="bg-gray-100">
        ...
        <div class="flex-1 content">
            <div class="container mx-auto p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-3xl font-bold">Cash Management</h1>
                    <div class="flex items-center gap-4">
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    ...
                                    <svg class="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 100-2H6z" clip-rule="evenodd"/>
                                    </svg>
                                </div>
                        ...
                        <button id="quickActionsBtn"
                            class="h-[42px] flex items-center justify-center px-6 bg-purple-500 hover:bg-purple-600 text-white font-semibold rounded-lg shadow-sm transition duration-200 ease-in-out transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
                        ...
                        <button id="printCashup"
                            class="h-[42px] flex items-center justify-center px-6 bg-gray-500 hover:bg-gray-600 text-white font-semibold rounded-lg shadow-sm transition duration-200 ease-in-out transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50"
                            style="margin-bottom:0;">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <?php
                ...
                <div id="quickActionsSection" class="bg-white shadow-lg rounded-lg mb-8 overflow-hidden hidden">
                    <div class="bg-gradient-to-r from-purple-500 to-teal-500 py-4 px-6">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <!-- Record Credit Return Button -->
                            <button id="recordCreditReturn" class="flex items-center justify-center p-4 bg-red-50 border border-red-200 rounded-lg hover:bg-red-100 transition-colors group">
                                <div class="text-center">
                                    <div class="p-3 bg-red-100 rounded-full mx-auto mb-3 group-hover:bg-red-200 transition-colors">
                                        <svg class="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"></path>
                                        </svg>
                                    </div>
                                    <h4 class="font-medium text-red-800">Record Credit Return</h4>
                                    <p class="text-sm text-red-600 mt-1"><?= $creditReturnsCount ?> returns today</p>
                                </div>
                            </button>
                            
                            <!-- Record EFT Income Button -->
                            <button id="recordEftIncome" class="flex items-center justify-center p-4 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition-colors group">
                                <div class="text-center">
                                    <div class="p-3 bg-blue-100 rounded-full mx-auto mb-3 group-hover:bg-blue-200 transition-colors">
                                    ...
                                    <h4 class="font-medium text-blue-800">Record EFT Income</h4>
                                    <p class="text-sm text-blue-600 mt-1"><?= $eftIncomeCount ?> transactions today</p>
                                </div>
                            </button>
                            
                            <!-- Record Damage Button -->
                            <button id="recordDamage" class="flex items-center justify-center p-4 bg-orange-50 border border-orange-200 rounded-lg hover:bg-orange-100 transition-colors group">
                                <div class="text-center">
                                    <div class="p-3 bg-orange-100 rounded-full mx-auto mb-3 group-hover:bg-orange-200 transition-colors">
                                        <svg class="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                                        </svg>
                                    </div>
                                    <h4 class="font-medium text-orange-800">Record Damage</h4>
                                    <p class="text-sm text-orange-600 mt-1"><?= $damagesCount ?> items today</p>
                                </div>
                            </button>
                            
                            <!-- Record Creditor Button -->
                            <button id="recordCreditor" class="flex items-center justify-center p-4 bg-purple-50 border border-purple-200 rounded-lg hover:bg-purple-100 transition-colors group">
                                <div class="text-center">
                                    <div class="p-3 bg-purple-100 rounded-full mx-auto mb-3 group-hover:bg-purple-200 transition-colors">
                                        <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                        </svg>
                                    </div>
                                    <h4 class="font-medium text-purple-800">Record Creditor</h4>
                                    <p class="text-sm text-purple-600 mt-1"><?= $creditorsCount ?> sales today</p>
                                </div>
                            </button>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        ...
                        <p class="cash-in-till text-2xl font-bold <?= $cashInTill >= 0 ? 'text-blue-600' : 'text-red-600' ?>">
                    ...
                    <div class="bg-white shadow-lg rounded-lg p-6">
                        ...
                        <p class="total-withdrawals text-2xl font-bold text-red-600">N$<?= number_format($selectedDateTotalWithdrawals, 2) ?></p>
    ...
    <script>
            ...
            if (quickActionsBtn && quickActionsSection) {
                quickActionsBtn.addEventListener('click', function() {
                    ...
                    if (isHidden) {
                        ...
                        quickActionsSection.style.transform = 'translateY(-10px)';
                        
                        setTimeout(() => {
                            quickActionsSection.style.opacity = '1';
                            quickActionsSection.style.transform = 'translateY(0)';
                        }, 10);
                    } else {
                        // Hide the section
                        quickActionsSection.style.opacity = '0';
        ...
        $(document).ready(function() {
            ...
            // Credit Return Modal
            $('#recordCreditReturn').on('click', function() {
                $('#creditReturnModal').removeClass('hidden');
            });
            
            $('#cancelCreditReturn, #cancelCreditReturn2').on('click', function() {
                $('#creditReturnModal').addClass('hidden');
                $('#creditReturnForm')[0].reset();
            });
            
            $('#creditReturnForm').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'cash.php',
                    method: 'POST',
                    data: $(this).serialize() + '&record_credit_return=1&ajax=1',
                    dataType: 'json',
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            showAlert(response.message || 'Error recording credit return', 'error');
                        }
                    },
                    error: function() {
                        showAlert('Error recording credit return', 'error');
                    }
                });
            });
            
            // EFT Income Modal
            $('#recordEftIncome').on('click', function() {
                $('#eftIncomeModal').removeClass('hidden');
            });
            
            $('#cancelEftIncome, #cancelEftIncome2').on('click', function() {
                $('#eftIncomeModal').addClass('hidden');
                $('#eftIncomeForm')[0].reset();
            });
            
            $('#eftIncomeForm').on('submit', function(e) {
                e.preventDefault();
                
                // Get form data
                const formData = {
                    total: parseFloat($('#eft_amount').val()),
                    cash_received: 0, // EFT payments have 0 cash received
                    payment_method: 'e-wallet',
                    transaction_ref: $('#transaction_ref').val(),
                    wallet_provider: $('#wallet_provider').val(),
                    items: [
                        {
                            name: 'EFT Income',
                            quantity: 1,
                            price: parseFloat($('#eft_amount').val())
                        }
                    ]
                };
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            showAlert('EFT income recorded successfully', 'success');
                            $('#eftIncomeModal').addClass('hidden');
                            $('#eftIncomeForm')[0].reset();
                            // Refresh the page to update badge counts
                            setTimeout(() => location.reload(), 1000);
                        } else {
                            showAlert(response.error || 'Error recording EFT income', 'error');
                        }
                    },
                    error: function(xhr) {
                        let errorMessage = 'Error recording EFT income';
            ...
            // Damage Modal
            $('#recordDamage').on('click', function() {
                $('#damageModal').removeClass('hidden');
            });
            
            $('#cancelDamage, #cancelDamage2').on('click', function() {
            ...
            $('#damageForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: 'cash.php',
                    method: 'POST',
                    data: $(this).serialize() + '&record_damage=1&ajax=1',
                    dataType: 'json',
                    success: function(response) {
                        if (response.status === 'success') {
                            showAlert(response.message, 'success');
                            ...
                            showAlert(response.message || 'Error recording damage', 'error');
                        }
                    },
                    error: function() {
                        showAlert('Error recording damage', 'error');
                    }
                });
            });
            
            // Creditor Modal
            $('#recordCreditor').on('click', function() {
                $('#creditorModal').removeClass('hidden');
            });
            
            $('#cancelCreditor, #cancelCreditor2').on('click', function() {
                $('#creditorModal').addClass('hidden');
                $('#creditorForm')[0].reset();
                $('#creditor_search').val('');
                $('#creditor_id').val('');
            });
            
            $('#creditorForm').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'cash.php',
                    method: 'POST',
                    data: $(this).serialize() + '&record_creditor=1&ajax=1',
                    dataType: 'json',
                    success: function(response) {
                        if (response.status === 'success') {
                            showAlert(response.message, 'success');
                            ...
                            showAlert(response.message || 'Error recording creditor sale', 'error');
                        }
                    },
                    error: function() {
                        showAlert('Error recording creditor sale', 'error');
                    }
                });
            });
            ...
            document.getElementById('printCashup').addEventListener('click', function() {
                ...
                document.getElementById('expectedCashAmount').textContent = expectedAmount.toFixed(2);
            });

            document.getElementById('cancelCashTill').addEventListener('click', function() {
                document.getElementById('cashTillModal').classList.add('hidden');
            });
            document.getElementById('cancelCashTill2').addEventListener('click', function() {
                document.getElementById('cashTillModal').classList.add('hidden');
            });

            document.getElementById('confirmCashTill').addEventListener('click', function() {
                const actualAmount = parseFloat(document.getElementById('actualCashInTill').value) || 0;
                const expectedAmount = parseFloat(document.getElementById('expectedCashAmount').textContent);
                ...
                .then(data => {
                    ...
                    const printData = Object.assign({}, cashupData, {
                        ...
                        expected_cash: expectedAmount, // Add the expected cash amount for receipt
    ...
    <div id="cashTillModal" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-500/50 backdrop-blur-sm transition-opacity duration-300 hidden">
    ...
    <!-- Credit Return Modal -->
    <div id="creditReturnModal" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-500/50 backdrop-blur-sm transition-opacity duration-300 hidden">
    ...
    <!-- EFT Income Modal -->
    <div id="eftIncomeModal" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-500/50 backdrop-blur-sm transition-opacity duration-300 hidden">
        <div class="relative w-full max-w-md mx-auto rounded-lg shadow-xl bg-white border border-gray-200 p-0 overflow-hidden">
            <div class="flex flex-col items-center px-6 py-6">
                <div class="flex items-center justify-between w-full mb-4">
    ...
    <!-- Damage Modal -->
    <div id="damageModal" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-500/50 backdrop-blur-sm transition-opacity duration-300 hidden">
        <div class="relative w-full max-w-md mx-auto rounded-lg shadow-xl bg-white border border-gray-200 p-0 overflow-hidden">
            <div class="flex flex-col items-center px-6 py-6">
                <div class="flex items-center justify-between w-full mb-4">
    ...
    <!-- Creditor Modal -->
    <div id="creditorModal" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-500/50 backdrop-blur-sm transition-opacity duration-300 hidden">
        <div class="relative w-full max-w-md mx-auto rounded-lg shadow-xl bg-white border border-gray-200 p-0 overflow-hidden">
            <div class="flex flex-col items-center px-6 py-6">
                <div class="flex items-center justify-between w-full mb-4">
