...
<!-- Mobile Loader - Premium Tailwind Style -->
<div id="mobileLoader" class="fixed inset-0 bg-gray-100 z-[10001] flex items-center justify-center lg:hidden transition-opacity duration-300" style="display: none; opacity: 0; visibility: hidden;">
    <div class="flex flex-col items-center justify-center space-y-6">
        <!-- Animated Logo to match index.php style -->
        <i class="fa-solid fa-cube fa-bounce text-gray-400"></i>
    </div>
</div>
<style>
@keyframes fade-in {
...
<aside id="sidebar" class="bg-[#f3f4f6] text-black w-64 h-screen p-6 shadow-lg fixed top-0 left-0 flex flex-col transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0" style="z-index: 999; overflow: hidden;">
    <style>
        .nav-link {
        ...
        /* Mobile sidebar positioning - up to 1023px, 1024px+ gets desktop */
            ...
            link.addEventListener('click', (e) => {
                ...
                if (window.innerWidth < 1024) {
                    ...
                    if (isOpen) {
                        ...
                        setTimeout(() => {
                            // Show mobile loader before navigation
                            const mobileLoader = document.getElementById('mobileLoader');
                            if (mobileLoader && window.innerWidth < 1024) {
                                // Remove fade-out and hidden classes
                                mobileLoader.classList.remove('hidden', 'fade-out');
                            ...
                            // Small delay to ensure loader is visible, then navigate
                            setTimeout(() => {
