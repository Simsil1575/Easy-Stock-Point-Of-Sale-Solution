        ...
        <div class="flex-1 content lg:ml-0 ml-0">
            ...
            <div class="container mx-auto p-6">
                ...
                <div class="print-section hidden print:block text-center mb-6">
                    ...
                    <p class="text-lg">Cashier: <?php echo htmlspecialchars($employeeName); ?></p>
                                    ...
                                    <?php if (empty($orders)): ?>
                                        <tr>
                                            <td colspan="6" class="px-6 py-12 text-center">
                                                ...
                                                <p class="text-gray-500 text-lg">No orders found for this cashier.</p>
                                            </td>
                                        </tr>
                                    <?php else: ?>
                                    ...
                                    <?php if (empty($items)): ?>
                                        <tr>
                                            <td colspan="4" class="px-6 py-12 text-center">
                                                ...
                                                <p class="text-gray-500 text-lg">No items found for this cashier.</p>
                                            </td>
                                        </tr>
                                    <?php else: ?>
                                        <?php 
            ...
            try {
                ...
                if (result.success) {
                    Swal.fire({
                        ...
                        text: 'Cashier cash-up receipt printed successfully!',
                        timer: 2000,
