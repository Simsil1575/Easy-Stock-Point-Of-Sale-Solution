...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="content flex-1 lg:ml-64 p-4 lg:p-6 mx-auto">
        <div class="lg:hidden flex items-center gap-2 mb-4">
            <a href="laybye.php" class="inline-flex items-center px-3 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors flex-shrink-0">
        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
            <div class="min-w-0 flex-1">
                <a href="laybye.php" class="hidden lg:inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors mb-3">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <?php if ($laybye['status'] === 'active'): ?>
                <form method="POST" id="formCancelLaybye" class="bg-red-50 border border-red-200 rounded-xl p-4">
                    <input type="hidden" name="laybye_id" value="<?= (int) $laybye['id'] ?>">
                    <input type="hidden" name="cancel_laybye" value="1">
                    <input type="hidden" name="manager_pin" id="cancelLaybyeManagerPin" value="">
                    <p class="text-sm text-red-800 mb-2">Cancel lay-bye: refund line on this account, restore inventory, remove payment orders from reports. Does not create a cash-out. Requires manager void PIN.</p>
                    <button type="button" id="btnCancelLaybye" class="bg-red-600 hover:bg-red-700 text-white text-sm font-medium px-4 py-2 rounded-lg">Cancel &amp; refund lay-bye</button>
                </form>
                <?php endif; ?>
            </div>
        </div>
