...
// Get all cashiers and waitresses for cash up modal dropdown (same as manager/home.php)
$allCashUpEmployees = [];
try {
...
<head>
    ...
    <title>Manager Operations - POS System</title>
...
<body class="bg-gray-100">
    <div class="flex min-h-screen">
        ...
        <div class="content flex-1 lg:ml-64">
            ...
            <div class="lg:hidden bg-white shadow-sm p-4 flex items-center justify-between sticky top-0 z-50">
                ...
                <h1 class="text-lg font-semibold text-gray-800">Manager Operations</h1>
                <div class="w-8"></div>
            </div>
            ...
            <main class="p-4 lg:p-6">
                <!-- Page Header -->
                <div class="mb-6">
                    <h1 class="text-2xl lg:text-3xl font-bold text-gray-800 mb-2">Manager Operations Center</h1>
                    <p class="text-gray-600">Quick access to all manager functions and operations</p>
                </div>
    ...
    <script>
        ...
        function updateCashUpReview() {
            ...
            document.getElementById('review_over_short').textContent = 'N$ ' + (cashOnHand - cashSalesExpected).toFixed(2);
            ...
            document.getElementById('review_eft_over_short').textContent = 'N$ ' + (eftOnHand - eftSalesExpected).toFixed(2);
