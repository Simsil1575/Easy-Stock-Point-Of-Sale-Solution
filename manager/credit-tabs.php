...
// #region agent log
@file_put_contents(__DIR__ . '/../debug-81774c.log', json_encode(['sessionId'=>'81774c','runId'=>'post-fix','hypothesisId'=>'H1','location'=>'manager/credit-tabs.php:27','message'=>'tab_balance_helper loaded without redeclare conflict','data'=>['recalculateTabBalance_exists'=>function_exists('recalculateTabBalance')],'timestamp'=>(int)round(microtime(true)*1000)])."\n", FILE_APPEND);
// #endregion
