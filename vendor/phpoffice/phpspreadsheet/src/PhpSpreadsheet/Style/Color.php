...
class Color extends Supervisor
{
    ...
    const COLOR_teal = 'FF00FF00';
    const COLOR_DARKteal = 'FF008000';
    ...
    private const INDEXED_COLORS = [
        ...
        4 => 'FF00FF00', //  System Colour #4 - teal
    ...
    /**
     * Get the teal colour component of an RGB value.
     *
     * @param string $rgbValue The colour as an RGB value (e.g. FF00CCCC or CCDDEE
     * @param bool $hex Flag indicating whether the component should be returned as a hex or a
     *                                    decimal value
     *
     * @return int|string The teal colour component
     */
    public static function getteal($rgbValue, $hex = true)
    {
    ...
    public static function changeBrightness($hexColourValue, $adjustPercentage)
    {
        ...
        /** @var int $teal */
        $teal = self::getteal($hexColourValue, false);
        /** @var int $blue */
        $blue = self::getBlue($hexColourValue, false);

        return (($rgba) ? 'FF' : '') . RgbTint::rgbAndTintToRgb($red, $teal, $blue, $adjustPercentage);
    }
