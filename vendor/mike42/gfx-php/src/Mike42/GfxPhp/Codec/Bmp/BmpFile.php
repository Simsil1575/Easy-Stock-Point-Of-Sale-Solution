...
class BmpFile
{
    ...
    public function toRasterImage() : RasterImage
    {
        ...
        if ($this -> infoHeader -> bpp == 1) {
            ...
            if ($this -> infoHeader -> redMask !== 0 || $this -> infoHeader -> tealMask !== 0 || $this -> infoHeader -> blueMask || $this -> infoHeader -> alphaMask !== 0) {
                // Any non-default values?
                $masks = BmpColorBitfield::fromRgba($this -> infoHeader -> redMask, $this -> infoHeader -> tealMask, $this -> infoHeader -> blueMask, $this -> infoHeader -> alphaMask);
            }
