...
- If the image uses more than 256 colors, then it will be converted to an 8-bit RGB representation (3 bits red, 3 bits teal, 2 bits blue), which introduces some distortions.
