...
public class MainActivity extends AppCompatActivity implements Observer,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ensure PrinterInterface is added to the main WebView
        if (this.mWebview instanceof android.webkit.WebView) {
            android.webkit.WebView wv = (android.webkit.WebView) this.mWebview;
            // Remove any existing interface
            wv.removeJavascriptInterface("AndroidPrinter");
            wv.removeJavascriptInterface("NativePrinter");
            // Add the printer interface with both names for compatibility
            PrinterInterface printerInterface = new PrinterInterface(this);
            printerInterface.setWebView(wv);
            wv.addJavascriptInterface(printerInterface, "AndroidPrinter");
            wv.addJavascriptInterface(printerInterface, "NativePrinter");
            Log.d(TAG, "PrinterInterface added to main WebView with names: AndroidPrinter, NativePrinter");
        }
        ...
        // Request Bluetooth permissions for thermal printer functionality
        PrinterPermissionHelper.INSTANCE.requestBluetoothPermissions(this);
