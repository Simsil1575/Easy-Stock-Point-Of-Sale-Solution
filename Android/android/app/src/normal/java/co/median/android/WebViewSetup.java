...
public class WebViewSetup {
    ...
    public static void setupWebviewForActivity(GoNativeWebviewInterface webview, MainActivity activity) {
        ...
        android.util.Log.d(TAG, "JSBridge interface added to WebView");

        // Add Android Printer interface for ESC/POS thermal printing
        wv.removeJavascriptInterface("AndroidPrinter");
        wv.removeJavascriptInterface("NativePrinter");
        PrinterInterface printerInterface = new PrinterInterface(activity);
        ...
        android.util.Log.d(TAG, "PrinterInterface added to WebView (AndroidPrinter, NativePrinter)");
    ...
    public static void setupWebview(GoNativeWebviewInterface webview, Context context) {
        ...
        // Add Android Printer interface for ESC/POS thermal printing
        // This needs to be added here as well for WebViewPool webviews
        wv.removeJavascriptInterface("AndroidPrinter");
        wv.removeJavascriptInterface("NativePrinter");
        PrinterInterface printerInterface = new PrinterInterface(context);
        printerInterface.setWebView(wv);
        wv.addJavascriptInterface(printerInterface, "AndroidPrinter");
        wv.addJavascriptInterface(printerInterface, "NativePrinter");
    }
