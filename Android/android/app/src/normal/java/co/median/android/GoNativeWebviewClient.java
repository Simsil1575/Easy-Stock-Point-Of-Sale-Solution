...
public class GoNativeWebviewClient extends WebViewClient {
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        // Inject Android Printer JavaScript interceptor for receipt.php calls
        injectPrinterInterceptor(view, "onPageFinished");
    }
    ...
    public void onPageCommitVisible(WebView view, String url) {
        ...
        // Also inject here as a backup - this fires earlier than onPageFinished
        injectPrinterInterceptor(view, "onPageCommitVisible");
    }
    
    private void injectPrinterInterceptor(WebView view, String source) {
        String printerInterceptorJs = PrinterInterface.getInterceptorJavaScript();
        view.evaluateJavascript(printerInterceptorJs, value -> {
            android.util.Log.d("PrinterInterceptor", "Injection from " + source + ": " + value);
        });
    }
