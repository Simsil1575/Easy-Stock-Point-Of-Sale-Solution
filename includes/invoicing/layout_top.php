...
$invBase = $invBase ?? (($roleFolder === 'cashier') ? '' : '../');
...
<head>
    ...
    <script src="<?= $invBase ?>navigation.js" async></script>
    <link href="<?= $invBase ?>src/output.css" rel="stylesheet">
    <link rel="icon" href="<?= $invBase ?>favicon.ico" type="image/png">
    <link rel="stylesheet" href="<?= $invBase ?>src/font-awesome/css/all.min.css">
    <script src="<?= $invBase ?>sweetalert2@11.js"></script>
    <style>
