    ...
    <div class="content flex-1 lg:ml-64 p-4 lg:p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div class="flex items-start gap-2 sm:gap-3 min-w-0 flex-1">
                <a href="cashier-center" class="inline-flex items-center px-3 py-2 sm:px-4 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg transition-colors text-sm font-medium flex-shrink-0" title="Back to Cashier Center">
                    <svg class="w-5 h-5 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div class="bg-white rounded-xl shadow border border-gray-100 overflow-hidden mb-4">
            <div class="p-4 flex flex-col lg:flex-row lg:flex-wrap gap-3 lg:items-end border-b border-gray-100">
                ...
                <div class="flex items-center gap-2">
                    <a href="laybye" class="px-4 py-2 border border-gray-300 rounded-lg text-sm text-gray-700 hover:bg-gray-50">Clear filters</a>
                </div>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <?php else: ?>
                            <?php foreach ($rows as $row): ?>
                                ...
                                ?>
                                <tr class="hover:bg-gray-50 cursor-pointer laybye-row transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-inset" tabindex="0" role="link" data-href="view-laybye?id=<?= (int) $row['id'] ?>" data-search="<?= htmlspecialchars($searchBlob, ENT_QUOTES) ?>" aria-label="View lay-bye <?= htmlspecialchars($row['reference'] ?? '', ENT_QUOTES) ?>">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex flex-wrap items-center gap-2">
                                            <a href="view-laybye?id=<?= (int) $row['id'] ?>" class="text-teal-600 hover:text-teal-800 text-sm font-medium">View</a>
                                            <?php
